 ...
 *******************************************************************************/
package ovh.tgrhavoc.aibot.protocol.v4x;
...
import ovh.tgrhavoc.aibot.protocol.v4x.handshake.PacketHC00_Handshake;
import ovh.tgrhavoc.aibot.protocol.v4x.login.client.PacketLC00_LoginStart;
import ovh.tgrhavoc.aibot.protocol.v4x.login.client.PacketLC01_EncryptionResponse;
import ovh.tgrhavoc.aibot.protocol.v4x.login.server.PacketLS00_Disconnect;
import ovh.tgrhavoc.aibot.protocol.v4x.login.server.PacketLS01_EncryptionRequest;
import ovh.tgrhavoc.aibot.protocol.v4x.login.server.PacketLS02_LoginSuccess;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC00_KeepAlive;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC01_Chat;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC02_UseEntity;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC03_PlayerUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC04_PositionUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC05_RotationUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC06_PositionRotationUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC07_BlockDig;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC08_BlockPlace;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC09_HeldItemChange;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC0A_Animation;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC0B_EntityAction;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC0D_CloseWindow;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC0E_ClickWindow;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC0F_ConfirmTransaction;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC15_ClientSettings;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC15_ClientSettings.ChatMode;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC15_ClientSettings.ViewDistance;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC16_ClientStatus;
import ovh.tgrhavoc.aibot.protocol.v4x.play.client.PacketC17_PluginMessage;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS00_KeepAlive;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS01_JoinGame;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS02_ChatMessage;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS03_TimeUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS04_EntityEquipment;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS05_SpawnLocation;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS06_UpdateHealth;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS07_Respawn;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS08_Teleport;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS09_ChangeHeldItem;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0A_EnterBed;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0B_Animation;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0B_Animation.Animation;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0C_SpawnPlayer;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0D_CollectItem;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0E_SpawnObject;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS0F_SpawnMob;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS10_SpawnPainting;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS11_SpawnExperienceOrb;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS12_EntityVelocityUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS13_DespawnEntities;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS14_EntityUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS15_EntityRelativeMovementUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS16_EntityRotationUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS17_EntityRelativeMovementRotationUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS18_EntityPositionRotationUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS19_EntityHeadRotationUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS1A_EntityStatusUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS1B_EntityAttachmentUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS1C_EntityMetadataUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS1D_EntityEffectUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS1E_EntityRemoveEffect;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS1F_ExperienceUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS20_EntityPropertyUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS21_ChunkData;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS21_ChunkData.ChunkData;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS22_MultiBlockUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS23_BlockUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS24_BlockAction;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS25_BlockBreakAnimation;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS26_MultiChunkData;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS2D_OpenWindow;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS2E_CloseWindow;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS2F_SetSlot;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS30_WindowItems;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS31_WindowProperty;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS32_ConfirmTransaction;
...
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS35_TileEntityUpdate;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS36_OpenTileEditor;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS37_Statistics;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS38_PlayerListItem;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS39_PlayerAbilities;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS3A_TabCompletion;
import ovh.tgrhavoc.aibot.protocol.v4x.play.server.PacketS40_Disconnect;
...
public final class Protocol4X extends AbstractProtocolX implements EventListener {
	...
	public void onRequestDisconnect(RequestDisconnectEvent event) {
		...
		handler.sendPacket(new PacketC04_PositionUpdate(Double.NaN, Double.NaN, Double.NaN, Double.NaN, false));
		if (handler.isConnected())
			handler.disconnect(event.getReason());
	}
